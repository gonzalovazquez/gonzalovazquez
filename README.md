...
### 🗂️ Repositories by category

- 🤖 [AI / Agent work](https://github.com/gonzalovazquez?tab=repositories&q=&type=&language=&sort=&topic=ai-agent) — Hal, agentic platforms, AI-native tooling
- 🚀 [Products](https://github.com/gonzalovazquez?tab=repositories&q=&type=&language=&sort=&topic=product) — shipped apps and APIs
